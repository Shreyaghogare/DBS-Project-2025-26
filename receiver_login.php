...
<head>
    ...
    <title>Receiver Login - FoodShare</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        body {
            font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
            background: linear-gradient(135deg, #00b8a9 0%, #005792 100%);
        ...
        .logo h1 { color: #005792; font-size: 26px; margin-top: 10px; }
        ...
        input:focus { outline: none; border-color: #00b8a9; }
        .login-btn { width: 100%; padding: 12px; background: #00b8a9; color: #fff; border: none; border-radius: 8px; font-size: 16px; font-weight: 600; cursor: pointer; transition: transform .2s; }
        .login-btn:hover { transform: translateY(-1px); }
        .back-home { text-align: center; margin-top: 14px; }
        .back-home a { color: #005792; text-decoration: none; }
    </style>
</head>
<body>
    <div class="login-container">
        ...
        <p class="subtitle">Access available food donations near you.</p>
        ...
        <form action="login.php" method="POST">
            <input type="hidden" name="redirect" value="receiver_login" />
