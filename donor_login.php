...
<head>
    ...
    <title>Donor Login - FoodShare</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .login-btn { width: 100%; padding: 12px; background: #667eea; color: #fff; border: none; border-radius: 8px; font-size: 16px; font-weight: 600; cursor: pointer; transition: transform .2s; }
...
<body>
    <div class="login-container">
        ...
        <p class="subtitle">Sign in to list surplus food and manage donations.</p>
        ...
        <form action="login.php" method="POST">
            <input type="hidden" name="redirect" value="donor_login" />
